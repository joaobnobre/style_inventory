...
const DragPreview: React.FC = () => {
    ...
    return (
        <>
            {isDragging && currentOffset && data.key && (
                <div
                    ...
                    style={{
                        ...
                        justifyContent: data.itemType && data.itemType == 'hotbar' || data.itemType == 'craft' ? 'flex-end' : 'space-between',
                        backgroundPosition: data.itemType && data.itemType == 'hotbar' || data.itemType == 'craft' ? 'center top 30%' : 'center',
                    }}
                >
                </div>
            )}
